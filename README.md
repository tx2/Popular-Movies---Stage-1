...
Then you need to go to `NetworkUtils.java` in `com.example.android.popularmovies.utilities` package file and replace the `[YOUR_API_KEY]` placeholder at the top of the file with your api key.
